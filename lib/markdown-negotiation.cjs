...
function selectRepresentation(headerValue) {
...
function acceptsMarkdown(headerValue) {
...
module.exports = { parseAcceptHeader, selectRepresentation, acceptsMarkdown, normalizeRequestPath, resolveMarkdownEntry, resolveDirectMarkdownEntry, resolveSidecarEntry, markdownAlternateLink, htmlRepresentationHeaders };

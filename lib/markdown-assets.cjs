...
module.exports = {
  ...
  "/insights/ksa-market-entry-guide-2026": {
    ...
    direct: "/insights/ksa-market-entry-guide-2026.md",
    language: "en",
  ...
  "/insights/foreign-ownership-saudi-arabia": {
    ...
    direct: "/insights/foreign-ownership-saudi-arabia.md",
    language: "en",
  ...
  "/insights/misa-licensing-commercial-registration-saudi-arabia": {
    ...
    direct: "/insights/misa-licensing-commercial-registration-saudi-arabia.md",
    language: "en",
  ...
  "/insights/vat-zakat-saudi-arabia": {
    ...
    direct: "/insights/vat-zakat-saudi-arabia.md",
    language: "en",
  ...
  "/insights/saudi-e-invoicing-operating-controls": {
    ...
    direct: "/insights/saudi-e-invoicing-operating-controls.md",
    language: "en",
  ...
  "/insights/regional-headquarters-rhq-saudi-arabia": {
    ...
    direct: "/insights/regional-headquarters-rhq-saudi-arabia.md",
    language: "en",
  ...
  "/insights/saudi-vendor-registration-aramco-pif": {
    ...
    direct: "/insights/saudi-vendor-registration-aramco-pif.md",
    language: "en",
  ...
  "/insights/saudization-nitaqat-hr-saudi-arabia": {
    ...
    direct: "/insights/saudization-nitaqat-hr-saudi-arabia.md",
    language: "en",
